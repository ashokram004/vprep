...
function Interviewsection() {
  ...
  function start(){
      ...
      //sessionStorage.setItem("curcompany",x);
  }
    ...
    <div id="interviewsection">
      ...
      <div id="companyblock">
        ...
        <div id="companieslist">
          ...
          <img id="firstpic" style={{marginLeft:'150px'}} className="pic" src={amazon} alt="" onClick={start}/>
          <img className="pic" src={infosys} alt="" onClick={start}/>
          <img className="pic" src={tcs} alt="" onClick={start}/>
          <img className="pic" src={wipro} alt="" onClick={start}/>
          <img className="pic" src={microsoft} alt="" onClick={start}/>
          <img className="pic" src={google} alt="" onClick={start}/>
      ...
      <div id="courseblock">
        ...
        <div id="companieslist">
          ...
          <img id="firstpic" style={{marginLeft:'150px'}} className="pic" src={clang} alt="" onClick={start}/>
          <img className="pic" src={cpp} alt="" onClick={start}/>
          <img className="pic" src={java} alt="" onClick={start}/>
          <img className="pic" src={python} alt="" onClick={start}/>
          <img className="pic" src={javascript} alt="" onClick={start}/>
          <img className="pic" src={mysql} alt="" onClick={start}/>
